...
import { Box,Stack, HStack, VStack ,Input, InputGroup, InputRightElement, Button} from '@chakra-ui/react'
...
const Signup = () => {
  ...
  const postDetails = (pics) =>{
    ...
    if(pics.type ==="image/jpeg" || pics.type ==="image/png" || pics.type ==="image/jpg"){
      ...
      data.append("cloud_name", "dg2o3dqwt");
      fetch("https://api.cloudinary.com/v1_1/dg2o3dqwt/image/upload",{
        method : 'post',
        body: data,
      }).then((res)=> res.json())
        .then(data => {
